...
void ConfigDialog::on_buttonBiomeColor_clicked()
{
    ...
    QString fnam = QFileDialog::getOpenFileName(this, "加載群系顏色圖", finfo.absolutePath(), "Text files (*.txt);;Any files (*)");
    if (!fnam.isNull())
    {
...
void ConfigDialog::on_buttonColorHelp_clicked()
{
    const char* msg =
            ...
            "</p></body></html>"
            ;
    QMessageBox::information(this, "幫助：自訂義群系顏色", msg, QMessageBox::Ok);
}
